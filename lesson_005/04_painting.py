...
# TODO не очень понял что такое take_background и draw_background
#  Возможно вы имели ввиду take_background - это то что двигается, draw_background - это то что статично?
#  вышло неплохо.

#  давайте анимируем картинку и там применим функции из библиотеки
#  take_background и draw_background для того чтобы фон не затирался

#  В главном файле с начало рисуем статику потом бесконечный цикл, и нем анимацию.
#  В вызываемых модулях, убираем везде while True и старт_драфтинг sd.pause()
#  после того как нарисовали статику используем take_background


#  Алгоритм такой, все статику вызываем до а динамику в цикле

#  создаем бесконечный цикл и в нем вызываем динамические функции в которых был или будет цикл while
#  старт_драфтинг
#  draw_background
#  рисуем радугу которая мигает
#  рисуем солнце которая переливается
#  рисуем смайл мигающий
#  рисуем снегопад
#  финиш_драфтинг
#  небольшую задержку
#  условия выхода
