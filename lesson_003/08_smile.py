...
# TODO не могу понять как нарисовать ломанную линию, какие параметры вершин передавать
# TODO так же при отрисовке элипса не понял какие точки у прямоугольникм
