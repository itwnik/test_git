...
#
# TODO в питоне очень важен нейминг, название переменных должно отражать суть объекта
# TODO запрещено использовать по PEP8 русские и имена написанные транслитом
# TODO Назовите message_1
s_m1 = secret_message[0][3]
s_m2 = secret_message[1][9:13]
s_m3 = secret_message[2][5:15:2]
s_m4 = secret_message[3][-20:-26:-1]
s_m5 = secret_message[4][20:15:-1]
# TODO можно написать через запятую принт сам расставит пробелы
s_m = s_m1 + ' ' + s_m2 + ' ' + s_m3 + ' ' + s_m4 + ' ' + s_m5
print(s_m)